...
def main() -> int:
    ...
    # Compose treats `$NAME` as interpolation in unquoted .env values. The
    # scrypt format contains several dollars, so single-quote it for a safe
    # copy/paste into .env. dotenv parsers remove the surrounding quotes.
